...
26. Prompts starting with "Bug:" must be saved to 01_requirements\03_REQUIREMENTS\99_Bugs.md - each new one should be numbered and written in format **Bug:** <description saved from the prompt> \n "**Fix**: <specific changes and explanation how they fix the bug> **Tests**: <names of the tests written to reproduce and retest the bug>
27. REMIND ME to commit after every KEEP ALL
